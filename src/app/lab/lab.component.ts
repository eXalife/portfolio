...
export class LabComponent {
  ...
  constructor(
    ...
    this.resourceService.addPreload('/assets/lab/primeng-themes/md-light-indigo.css', 'style', undefined, '(prefers-color-scheme: light)');
    this.resourceService.addPreload('/assets/lab/primeng-themes/md-dark-indigo.css', 'style', undefined, '(prefers-color-scheme: dark)');
